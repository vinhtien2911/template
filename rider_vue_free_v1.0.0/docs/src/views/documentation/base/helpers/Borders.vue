    ...
    <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
      ...
      <div class="pb-10">
        ...
        <div class="py-5">
          ...
          >
          in
          <code>src/assets/sass/core/components/helpers/_borders.scss</code> to
      ...
      <div class="py-10">
        ...
        <div class="py-5">
          ...
          <ul class="pt-3">
            <li class="py-2">
              <code>top</code>- for classes that set border top style
            </li>
            <li class="py-2">
              <code>bottom</code>- for classes that set border bottom style
            </li>
            <li class="py-2">
              <code>end</code>- for classes that set border right style
            </li>
            <li class="py-2">
              <code>start</code>- for classes that set border start style
            </li>
          </ul>
        </div>
        <!--end::Block-->
      ...
      <div class="py-10">
        <!--begin::Heading-->
        <h1 class="anchor fw-bolder mb-3" id="hover-state">
          <a href="#hover-state"></a>
          Hover State
        </h1>
        <!--end::Heading-->
...
<div class="border border-primary border-hover">
  primary
      ...
      <div class="py-10">
        <!--begin::Heading-->
        <h1 class="anchor fw-bolder mb-3" id="actve-state">
          <a href="#actve-state"></a>
          Active State
        </h1>
        <!--end::Heading-->
        ...
        <!--begin::Block-->
        <div class="py-5">
          Use <code>.border-active</code>to display an element's border when
          <code>.active</code>class applied.
        </div>
        <!--end::Block-->
        ...
        <div class="py-5">
          <div class="rounded border p-10">
            <div class="d-flex flex-wrap align-items-center">
              ...
              <div
                class="
                  border border-gray-500 border-active
                  active
                  w-125px
                  h-125px
                  d-flex
              ...
              <div
                class="
                  border border-primary border-active
                  active
                  w-125px
                  h-125px
                  d-flex
...
<div class="border border-primary border-active active">
  primary
      ...
      <div class="py-10">
        <!--begin::Heading-->
        <h1 class="anchor fw-bolder mb-3" id="transparent-state">
          <a href="#transparent-state"></a>
          Transparent Border
        </h1>
        <!--end::Heading-->
        ...
        <!--begin::Block-->
        <div class="py-5">
          Use <code>.border-transparent</code>to set an element's border color
          to tranparent.
        </div>
        <!--end::Block-->
