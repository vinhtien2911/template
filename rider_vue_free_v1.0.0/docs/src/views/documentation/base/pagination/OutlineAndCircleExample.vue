<template>
  ...
  <div class="pt-10">
    <!--begin::Heading-->
    <h1 class="anchor fw-bolder mb-5" id="outline-and-circle-example">
      <a href="#outline-and-circle-example"></a>
      Outline And Circle Example
    </h1>
    <!--end::Heading-->

    <!--begin::Block-->
    <div class="py-5">Pagination with outline and circle buttons:</div>
    <!--end::Block-->
