<template>
  <div class="pb-10">
    <h1 class="anchor fw-bolder mb-5" id="icon-and-text-color-style">
      <a href="#icon-and-text-color-style"></a>
      Icon & Text Color Styles
    </h1>
    <!--end::Heading-->

    <div class="py-5">
      Use <code>.btn-icon-{text-color}</code> and
      <code>.btn-text-{text-color}</code> Bootstrap Button classes to set a
      button's icon and text colors separately:
    </div>
    <!--end::Block-->
      ...
      <div class="py-5">
        <div class="rounded border p-10">
          ...
          <a
            href="#"
            class="
              btn btn-bg-dark btn-icon-secondary btn-text-secondary
              me-2mb-2
            "
          >
            <span class="svg-icon svg-icon-1">
          ...
          <a
            href="#"
            class="
              btn btn-bg-dark btn-icon-gray-100 btn-text-gray-100
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-dark btn-icon-gray-200 btn-text-gray-200
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-dark btn-icon-gray-300 btn-text-gray-300
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-400 btn-text-gray-400
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-500 btn-text-gray-500
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-600 btn-text-gray-600
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-700 btn-text-gray-700
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-800 btn-text-gray-800
              me-2
              mb-2
            "
          >
          ...
          <a
            href="#"
            class="
              btn btn-bg-light btn-icon-gray-900 btn-text-gray-900
              me-2
              mb-2
            "
          >
