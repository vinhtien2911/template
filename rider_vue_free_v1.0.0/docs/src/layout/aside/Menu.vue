  ...
  >
    ...
    >
      <template v-for="(item, i) in DocMenuConfig" :key="i">
        <div v-if="item.pro" class="menu-item">
          <div class="menu-link">
        ...
        <div v-if="item.heading && !item.pro" class="menu-item">
          ...
          >
            ...
            >
              <template v-for="(item2, k) in menuItem.sub" :key="k">
                <div v-if="item2.pro" class="menu-item">
                  <div class="menu-link">
                    <span class="menu-title"
                      >{{ item2.heading
                      }}<span
                ...
                <div v-if="item2.heading && item2.pro" class="menu-item">
                  <router-link
                    v-slot="{ href, navigate, isActive, isExactActive }"
                    :to="item2.route"
                  >
