        ...
        <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
          ...
          <div class="d-flex flex-stack mb-10 mb-lg-15">
            ...
            <div class="my-1">
              ...
              <button @click="print()" class="btn btn-sm btn-success me-2">
                Print
              </button>
        ...
        <div class="m-0">
          ...
          >
            ...
            <div class="mb-15">
              ...
              <div
                class="fw-bolder fs-6 text-gray-800 d-flex align-items-center"
              >
                14 days
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      setCurrentPageBreadcrumbs("Invoices", ["Pages", "Invoices"]);
    });
